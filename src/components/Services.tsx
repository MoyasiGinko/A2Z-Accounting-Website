    ...
    <>
      ...
      >
        <div className="e-con-inner">
          ...
          <div
            className="elementor-element elementor-element-eb91688 elementor-invisible elementor-widget-tablet__width-initial elementor-widget__width-initial animated-fast elementor-widget elementor-widget-heading"
            data-id="eb91688"
            data-element_type="widget"
          ...
          >
            <div className="elementor-widget-container">
              <span className="elementor-heading-title elementor-size-default">
                With years of experience and a results-focused approach, we
                empower businesses to navigate complexity and achieve their
                goals.
              </span>
            </div>
          </div>
      ...
      <div
        className="elementor-element elementor-element-0a5fdf3 e-flex e-con-boxed e-con e-parent"
        data-id="0a5fdf3"
        data-element_type="container"
      >
        <div className="e-con-inner">
          ...
          >
            <div
              className="elementor-element elementor-element-1f1e3cb e-con-full e-flex e-con e-child"
              data-id="1f1e3cb"
              data-element_type="container"
              data-settings='{"background_background":"classic"}'
            >
              <div
                className="elementor-element elementor-element-99f443c elementor-widget elementor-widget-image"
                data-id="99f443c"
                data-element_type="widget"
                data-widget_type="image.default"
              >
                <div className="elementor-widget-container">
                  <img
                    ...
                    className="attachment-medium size-medium wp-image-334"
                    alt=""
                  />
                </div>
              </div>
              <div
                className="elementor-element elementor-element-cc096c9 elementor-widget elementor-widget-heading"
                data-id="cc096c9"
                data-element_type="widget"
                data-widget_type="heading.default"
              >
            ...
            <div
              className="elementor-element elementor-element-7aabc05 e-con-full e-flex e-con e-child"
              data-id="7aabc05"
              data-element_type="container"
            >
              <div
                className="elementor-element elementor-element-5d0cfbd elementor-icon-list--layout-traditional elementor-list-item-link-full_width elementor-widget elementor-widget-icon-list"
                data-id="5d0cfbd"
                data-element_type="widget"
                data-widget_type="icon-list.default"
              >
              ...
              <div
                className="vamtam-has-theme-widget-styles elementor-element elementor-element-d282ade vamtam-icon-pos-row-reverse elementor-align-justify vamtam-content-align-space-between elementor-widget elementor-widget-button"
                data-id="d282ade"
                data-element_type="widget"
                data-widget_type="button.default"
              >
          ...
          <div
            className="elementor-element elementor-element-ae99a1f elementor-invisible e-con-full vamtam-icon-hover-parent animated-fast e-flex e-con e-child"
            data-id="ae99a1f"
            data-element_type="container"
            data-settings='{"background_background":"classic","animation":"slideInUp","animation_delay":150}'
          >
            <div
              className="elementor-element elementor-element-ed8231c e-con-full e-flex e-con e-child"
              data-id="ed8231c"
              data-element_type="container"
              data-settings='{"background_background":"classic"}'
            >
              <div
                className="elementor-element elementor-element-0c5b429 elementor-widget elementor-widget-image"
                data-id="0c5b429"
                data-element_type="widget"
                data-widget_type="image.default"
              >
                <div className="elementor-widget-container">
                  <img
                    ...
                    className="attachment-medium size-medium wp-image-333"
                    alt=""
                  />
                </div>
              </div>
              <div
                className="elementor-element elementor-element-5eee277 elementor-widget elementor-widget-heading"
                data-id="5eee277"
                data-element_type="widget"
                data-widget_type="heading.default"
              >
                <div className="elementor-widget-container">
                  <h3 className="elementor-heading-title elementor-size-default">
                    <a href="https://execor.vamtam.com/services/talent-acquisition/">
                      Talent Acquisition
                    </a>
                  </h3>
                </div>
            ...
            <div
              className="elementor-element elementor-element-2266b4e e-con-full e-flex e-con e-child"
              data-id="2266b4e"
              data-element_type="container"
            >
              <div
                className="elementor-element elementor-element-f906130 elementor-icon-list--layout-traditional elementor-list-item-link-full_width elementor-widget elementor-widget-icon-list"
                data-id="f906130"
                data-element_type="widget"
                data-widget_type="icon-list.default"
              >
              ...
              <div
                className="vamtam-has-theme-widget-styles elementor-element elementor-element-007e57b vamtam-icon-pos-row-reverse elementor-align-justify vamtam-content-align-space-between elementor-widget elementor-widget-button"
                data-id="007e57b"
                data-element_type="widget"
                data-widget_type="button.default"
              >
