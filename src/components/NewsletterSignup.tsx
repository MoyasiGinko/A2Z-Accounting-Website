...
const NewsletterSignup = () => {
  ...
  return (
    <div
      className="elementor-element elementor-element-befd5d0 e-con-full e-flex e-con e-parent"
      data-id="befd5d0"
      data-element_type="container"
    >
      <div
        className="elementor-element elementor-element-9356354 elementor-widget elementor-widget-template"
        data-id="9356354"
                ...
                <div className="e-con-inner">
                  ...
                  >
                    <div
                      ...
                      data-id="3b33bfe"
                      data-element_type="widget"
                      data-settings='{"button_width":"25","step_next_label":"Next","step_previous_label":"Previous","button_width_tablet":"25","step_type":"number_text","step_icon_shape":"circle"}'
                        ...
                        >
                          ...
                          {message && (
                            <div
                              ...
                              style={{
                                marginTop: "10px",
                                color: message.includes("Thank you")
                                  ? "#28a745"
                                  : "#dc3545",
                              }}
                            >
                    ...
                    <div
                      className="elementor-element elementor-element-82aa64e elementor-widget__width-initial elementor-widget-tablet__width-inherit elementor-widget elementor-widget-text-editor"
                      data-id="82aa64e"
                      data-element_type="widget"
                    ...
                    >
                      <div className="elementor-widget-container">
                        <p>
                          You can unsubscribe at any time using the link in the
                          footer of our emails. View our{" "}
                          <a href="https://execor.vamtam.com/privacy-policy/">
                            Privacy Policy
                          </a>
                          .
                        </p>
