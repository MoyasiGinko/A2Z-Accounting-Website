  ...
  return (
    <>
      ...
      <div
        ...
        data-element_type="container"
      >
        <div className="e-con-inner gap-2 text-[#162C45]">
          {visionItems.map((item) => (
            <div
              key={item.containerId}
              className={`elementor-element elementor-element-${item.containerId} elementor-invisible e-con-full animated-fast e-flex e-con e-child bg-white`}
                ...
                <div className="elementor-widget-container">
                  <div className="elementor-icon-box-wrapper">
                    ...
                    <div className="elementor-icon-box-content">
                      <h5 className="elementor-icon-box-title text-[#162C45]">
