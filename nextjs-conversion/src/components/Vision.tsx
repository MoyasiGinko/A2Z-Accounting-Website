    ...
    <>
      ...
      >
        <div className="e-con-inner">
          <div
            className="elementor-element elementor-element-ffb023a elementor-invisible e-con-full animated-fast e-flex e-con e-child"
            data-id="ffb023a"
            data-element_type="container"
            data-settings='{"animation":"slideInUp","animation_delay":0}'
          >
            <div
              className="elementor-element elementor-element-69c379a elementor-position-left elementor-mobile-position-left elementor-tablet-position-left elementor-vertical-align-middle elementor-view-default elementor-widget elementor-widget-icon-box"
              data-id="69c379a"
              data-element_type="widget"
            ...
            <div
              className="elementor-element elementor-element-82a910c elementor-widget elementor-widget-text-editor"
              data-id="82a910c"
              data-element_type="widget"
          ...
          <div
            className="elementor-element elementor-element-ba74473 elementor-invisible e-con-full animated-fast e-flex e-con e-child"
            data-id="ba74473"
            data-element_type="container"
            data-settings='{"animation":"slideInUp","animation_delay":50}'
          >
            <div
              className="elementor-element elementor-element-234de0a elementor-position-left elementor-mobile-position-left elementor-vertical-align-middle elementor-view-default elementor-widget elementor-widget-icon-box"
              data-id="234de0a"
              data-element_type="widget"
              data-widget_type="icon-box.default"
            >
            ...
            <div
              className="elementor-element elementor-element-3dc1e54 elementor-widget elementor-widget-text-editor"
              data-id="3dc1e54"
              data-element_type="widget"
              data-widget_type="text-editor.default"
            >
              <div className="elementor-widget-container">
                <p>
                  Combining data-driven insights with tailored solutions, we
                  create actionable strategies that drive real business results.
                </p>
              </div>
            </div>
          </div>
          <div
            className="elementor-element elementor-element-6725fc0 elementor-invisible e-con-full animated-fast e-flex e-con e-child"
            data-id="6725fc0"
            data-element_type="container"
            data-settings='{"animation":"slideInUp","animation_delay":100}'
          >
            <div
              className="elementor-element elementor-element-13b708f elementor-position-left elementor-mobile-position-left elementor-vertical-align-middle elementor-view-default elementor-widget elementor-widget-icon-box"
              data-id="13b708f"
              data-element_type="widget"
              data-widget_type="icon-box.default"
            >
            ...
            <div
              className="elementor-element elementor-element-c4183f6 elementor-widget elementor-widget-text-editor"
              data-id="c4183f6"
              data-element_type="widget"
              data-widget_type="text-editor.default"
            >
